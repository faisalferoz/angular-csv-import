/*! angular-csv-import - v0.0.38 - 2018-03-31
...
csvImport.directive('ngCsvImport', function() {
    return {
        ...
        template: function(element, attrs) {
            ...
            var mdSvgIcon = angular.isDefined(attrs.mdSvgIcon);
            ...
            (material ? '<md-button ng-click="onClick($event)" class="_md md-button {{mdButtonClass}}">' +
            (mdSvgIcon ? '<md-icon md-svg-icon="{{mdSvgIcon}}"></md-icon>' : '') +
            ' {{mdButtonTitle}}</md-button><md-input-container style="margin:0;"><input type="text" class="_md md-input-readable md-input {{mdInputClass}}" ng-click="onClick($event)" ng-model="filename" ng-show="{{mdShowFile}}"></md-input-container>' : '') +
            '</div>'+
            '</div>';
        },
